...
public class Alumno {
    ...
    /**
     * Se piden las notas y en caso de que no sea valida la nota, salta el
     * error.
     *
     ...
     * @param nnota: nuevo valor que se le va a dar a la nota que esta en al
     * posicion anterior.
     * @throws RangoException: en caso de que haya error, se lanzara esta
     * excepcion.
     * @throws MisteriosaException: en caso de que la posicion no sea valida se
     * lanzara este otro error.
     */
